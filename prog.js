...
function deleteOne(str,tr){
  if(tr === true){console.log(newstringa)}
  else{
    console.log()
  }
...
*/
let birthday= thirdofmarch

function isTodayMyBirthday(){
  if(birthday<thirdofmarch){console.log('non è il mio compleanno')}
  else if (birthday > thirdofmarch){console.log('non è il mio compleanno')}
  else {console.log('è il mio compleanno')}
...
*/
const baby = function(){
  let allbaby = document.getElementById('container')
...
const alltags = function (){
  let alltags = document.getElementsByTagName('td')
}
/* ESERCIZIO 22
  Scrivi una funzione che, tramite un ciclo, stampa in console il testo contenuto in ogni tag <td> all'interno della pagina.
*/
const alltag= document.getElementsByTagName('td')
alltag.forEach((a )=>{
  a.onclick = clickOnTd
})
/* ESERCIZIO 23
...
*/
const allTheTr = function () {
 
let allLis = document.querySelectorAll('tr')}

   allLis.forEach((tr) => {
    tr.classList.toggle('add')
  })
// [EXTRA] JS Avanzato
